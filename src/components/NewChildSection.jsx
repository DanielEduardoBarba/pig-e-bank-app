...
export default function NewChildSection({ setParentModal, setNewChild, setError, userID }) {
            ...
            if (adminPin && childName && pin) {
                ...
                fetch(`${API_URL}/children`, {
                    ...
                    .then(response => {
                        ...
                        if (response.serverStatus == 2) setParentModal(0)
        ...
        <>
            <form id="transaction-form" className="transaction-form" onSubmit={e => createChildAccount(e)}>
                <input style={{
                    ...
                    type="password"
                    onChange={e => {
                        if (e.target.value >= 0) setAdminPin(e.target.value)
                ...
                <input style={{
                    ...
                    type="password"
                    onChange={e => {
                        if (e.target.value >= 0) setConfirmAdminPin(e.target.value)
